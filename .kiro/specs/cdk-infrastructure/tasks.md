...
- [x] 5. チェックポイント - 基本リソースの動作確認
  - すべてのテストが通ることを確認し、ユーザーに質問があれば確認する

- [x] 6. Lambda Function URLの実装
  - Function URLの作成と設定
  - CORS設定とNONE認証タイプの設定
  - POSTリクエスト受け入れ設定
...
- [x] 8. CloudFrontディストリビューションの実装
  - S3バケットをオリジンとするCloudFrontディストリビューション作成
  - HTTPS強制とキャッシュ設定
  - デフォルトルートオブジェクト（index.html）設定
  - _要件: 2.1, 2.2, 2.3, 2.4_

- [x]* 8.1 CloudFrontディストリビューションのユニットテストを作成
  - **要件2.1-2.4の検証**
  - **検証対象: CloudFrontディストリビューション、HTTPS強制、デフォルトルートオブジェクト、OAI**

- [x] 9. S3バケットデプロイメント機能の実装
